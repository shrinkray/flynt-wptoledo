...
add_filter('Flynt/addComponentData?name=FormContactForm7', function (array $data): array {
...
add_action('wpcf7_init', function (): void {
    wpcf7_add_form_tag('submit', function ($tag): string {
        ...
        return sprintf('<button %1$s>%2$s</button>', $atts, $value);
    });
}, 10, 0);
